...
dm_menu = {
    ...
    "join_club": {
        "embed": embed( title="Brawl Stars Clubs", color=discord.Color.orange(),
    ...
    "end_guest": {
        "embed": embed( title="Enjoy your stay", color=discord.Color.orange(),
                        description="Welcome to the **Mystic India - BrawlStars** Discord server. "
                                    ...
                                    "For games, you can check out `#heist`"
                                    "and `#challenges`.\n\nIf you would like to invite "
                                    "your friends to join this server, you may use this "
                                    "Discord invite: <https://discord.gg/nnp9Zw5>\n\n"
                                    "Additional help and information: Ask Anywhere"
                                    "Thanks + enjoy!\n" ),
        "options": [
            {
    ...
    "global_chat": {
        "embed": embed( title="#global-chat", color=discord.Color.orange(),
                        description="Click here: https://discord.gg/n3YYTMh" ),
        "options": [
            {
                "name": "Done",
                "emoji": Symbol.white_check_mark,
    ...
    "welcome_gate": {
        "embed": embed( title="#welcome-gate", color=discord.Color.orange(),
                        description="Click here: https://discord.gg/nnp9Zw5" ),
        "options": [
            {
                "name": "Done",
                "emoji": Symbol.white_check_mark,
...
class welcome:
    ...
    async def guest(self, member: discord.Member):
        ...
        server = self.bot.get_server( "593732431551660063" )
    ...
    async def verify_membership(self, member: discord.Member):
        ...
        await self.bot.send_message( discord.Object( id='599816861789716522' ), welcomeMsg.format(
            member ) )  # Weirdo914, i have given here id of #global-Chat , idk whats of that
    ...
    async def logger(self, user):
        """Log into a channel"""
        channel = self.bot.get_channel( "599824035391602688" )  # weirdo i have given here the id of #invite-log
    ...
    async def on_member_join(self, member):
        ...
        if server.id != "593732431551660063":
            return
        await self.bot.send_message(server.get_channel("599821456578314251"), content=" <:MI:646313129340436480> ** welcome <@{}>! Do you play Brawl Stars? then contact Admins right now! do `!bsave #tag` to save your bs tag. Dont play brawl stars? take your roles from #auto-roles .format(member.id))  # here also #invite-log
    ...
    async def on_member_remove(self, member):
        ...
        await self.bot.send_message( server.get_channel( "599824035391602688" ), embed=embed )  # here also #invite-log
