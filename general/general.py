...
credit = "Cog edited by Weirdo914"
...
class General:
    ...
    async def create(self, ctx, names: str):
        await self.bot.create_channel(ctx.message.server, names, type=discord.ChannelType.text)
    ...
    async def ping(self, ctx):
        ...
        await self.bot.edit_message(t, new_content='Pong! {} ms'.format(int(ms)))

    @commands.command(hidden=True, pass_context=True)
    async def advping(self, ctx):
        """Advanced Ping."""
        def returnhex():
        ...
        e.add_field(name='Ping 2', value=str(ra1) + " ms")
        e.add_field(name='Ping 3', value=str(ra2) + " ms")
        e.add_field(name='Ping 4', value=str(ra3) + " ms")
        e.add_field(name='Ping 5', value=str(ra4) + " ms")
        e.add_field(name='Average Ping', value=str(avg) + " ms")
        e.set_footer(text=credit, icon_url=icon)
...
class NewPoll():
    ...
    async def start(self):
        ...
        await self.sel.bot.send_message(self.channel, msg)
